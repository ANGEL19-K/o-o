...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.body.classList.add('bg-verde');
    document.getElementById('noBtn').style.display = 'none';

    // Mostrar el mensaje específico
    document.getElementById('messageContainer').style.display = 'block';
    document.getElementById('messageContainer').innerHTML = '¡GRACIAS 1.40 SALE COD? XD!';

    // Mostrar otros gifs después de ciertos tiempos
    setTimeout(function() {
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 6:
            document.getElementById('noBtn').innerHTML = 'Sí, dices que no estaré muy triste';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 15:
            document.getElementById('noBtn').innerHTML = 'Anda Siiiiiiiiiiiiiii';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
